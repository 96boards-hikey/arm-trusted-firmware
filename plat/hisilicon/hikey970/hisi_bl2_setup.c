 ...
 ******************************************************************************/
#if LOAD_IMAGE_V2
int plat_hisi_bl2_handle_scp_bl2(image_info_t *scp_bl2_image_info)
#else
 ...
 ******************************************************************************/
uint32_t hisi_get_spsr_for_bl32_entry(void)
{
	/*
 ...
 ******************************************************************************/
#ifndef AARCH32
uint32_t hisi_get_spsr_for_bl33_entry(void)
{
	unsigned int mode;
	uint32_t spsr;
...
#if LOAD_IMAGE_V2
int hisi_bl2_handle_post_image_load(unsigned int image_id)
{
	int err = 0;
...
#endif
		bl_mem_params->ep_info.spsr = hisi_get_spsr_for_bl32_entry();
		break;
#endif
	...
	case BL33_IMAGE_ID:
		...
		bl_mem_params->ep_info.spsr = hisi_get_spsr_for_bl33_entry();
		break;

#ifdef SCP_BL2_BASE
	case SCP_BL2_IMAGE_ID:
		/* The subsequent handling of SCP_BL2 is platform specific */
		err = plat_hisi_bl2_handle_scp_bl2(&bl_mem_params->image_info);
		if (err)
...
{
	return hisi_bl2_handle_post_image_load(image_id);
}
...
{
#if DEBUG
	bl31_params_mem.bl31_ep_info.args.arg1 = HISI_BL31_PLAT_PARAM_VAL;
#endif
...
{
	hisi_init_mmu_el1(bl2_tzram_layout.total_base,
